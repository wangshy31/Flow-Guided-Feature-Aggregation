...
def pred_eval(gpu_id, feat_predictors, test_data, imdb, cfg, vis=False, thresh=1e-3, logger=None, ignore_cache=True):
    ...
    tmp_mem0_block5 = mx.nd.zeros((1, 2048, 94, 94), ctx = mx.gpu(int(gpu_id)))
    tmp_mem1_block5 = mx.nd.zeros((1, 2048, 94, 94), ctx = mx.gpu(int(gpu_id)))
    tmp_mem2_block5 = mx.nd.zeros((1, 2048, 94, 94), ctx = mx.gpu(int(gpu_id)))
    tmp_mem3_block5 = mx.nd.zeros((1, 2048, 94, 94), ctx = mx.gpu(int(gpu_id)))
    tmp_mem4_block5 = mx.nd.zeros((1, 2048, 94, 94), ctx = mx.gpu(int(gpu_id)))
    for im_info, key_frame_flag, data_batch in test_data:
        t1 = time.time() - t
        t = time.time()
        ...
        for index in range(pre_filename.shape[0]):
            data_batch.data[index][11] = pre_filename[index]
            data_batch.data[index][12] = pre_filename_pre[index]
            ...
            mx.nd.expand_dims(tmp_mem0_block5[index], axis=0).copyto(data_batch.data[index][4])
            mx.nd.expand_dims(tmp_mem1_block5[index], axis=0).copyto(data_batch.data[index][5])
            mx.nd.expand_dims(tmp_mem2_block5[index], axis=0).copyto(data_batch.data[index][6])
            mx.nd.expand_dims(tmp_mem3_block5[index], axis=0).copyto(data_batch.data[index][7])
            mx.nd.expand_dims(tmp_mem4_block5[index], axis=0).copyto(data_batch.data[index][8])
        ...
        for index in range(pre_filename.shape[0]):
            ...
            tmp_mem0_block5[index,:, 0:shape2, 0:shape3] = output[index]['blockgrad0_output']
            tmp_mem1_block5[index,:, 0:shape2, 0:shape3] = output[index]['blockgrad1_output']
            tmp_mem2_block5[index,:, 0:shape2, 0:shape3] = output[index]['blockgrad2_output']
            tmp_mem3_block5[index,:, 0:shape2, 0:shape3] = output[index]['blockgrad3_output']
            tmp_mem4_block5[index,:, 0:shape2, 0:shape3] = output[index]['blockgrad4_output']

            pre_filename[index] = data_batch.data[index][9]
            pre_filename_pre[index] = data_batch.data[index][10]
