...
def get_rpn_testbatch(roidb, cfg, cur_roidb_index, cur_frameid):
    ...
    data = [{'data': im_array[i],
            ...
            'max_cell': np.zeros((1, 512, 94, 94), dtype=np.float32),
            'max_hidden': np.zeros((1, 512, 94, 94), dtype=np.float32),
            'max_cell2': np.zeros((1, 512, 94, 94), dtype=np.float32),
            'max_hidden2': np.zeros((1, 512, 94, 94), dtype=np.float32),
            'max_cell3': np.zeros((1, 512, 94, 94), dtype=np.float32),
            'max_hidden3': np.zeros((1, 512, 94, 94), dtype=np.float32),
...
def get_rpn_triple_batch(roidb, cfg):
    ...
    data = {'data': im_array,
            ...
            #'max_mem_block3': np.zeros((1, 512, 157, 157), dtype=np.float32),
            #'max_mem_block4': np.zeros((1, 1024, 94, 94), dtype=np.float32),
            'max_mem_block5': np.zeros((1, 1024, 94, 94), dtype=np.float32),
