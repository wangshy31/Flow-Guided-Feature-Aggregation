...
def get_rpn_testbatch(roidb, cfg, cur_roidb_index, cur_frameid):
    ...
    data = [{'data': im_array[i],
            ...
            'max_mem0_block5': np.zeros((1, 2048, 94, 94), dtype=np.float32),
            'max_mem1_block5': np.zeros((1, 2048, 94, 94), dtype=np.float32),
            'max_mem2_block5': np.zeros((1, 2048, 94, 94), dtype=np.float32),
            'max_mem3_block5': np.zeros((1, 2048, 94, 94), dtype=np.float32),
            'max_mem4_block5': np.zeros((1, 2048, 94, 94), dtype=np.float32),
